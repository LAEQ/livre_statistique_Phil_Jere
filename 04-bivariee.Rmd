...
La régression linéaire simple se distingue ainsi de la **covariance** (section \@ref(sect312)) et de la **corrélation** (section \@ref(sect313)), relevant de la statistique bivariée descriptive et exploratoire. 
...
ggplot(df, aes(x = Values)) + 
  ...
  annotate("text", x=250, y = 0.028, 
           label = paste("Mombre moyen de corrélations significatives\n 
