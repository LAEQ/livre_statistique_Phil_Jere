...
La courte syntaxe R ci-dessous permet de générer le tableau \@ref(tab:tableCritiqueKhi2) avec les valeurs critiques du khi-deux pour différents degrés de signification (valeurs de *p*).
...
```{r tableCritiqueKhi2, echo=FALSE, message=FALSE, warning=FALSE}
show_table(tableKhi2, 
           digits = 2,
           caption = "Distribution des valeurs critiques du khi-deux",
...
La courte syntaxe R ci-dessous permet de générer les tableaux \@ref(tab:tableCritiqueF1), \@ref(tab:tableCritiqueF2) et \@ref(tab:tableCritiqueF3) avec les valeurs critiques de *F* avec *p*&nbsp;=&nbsp;0,05.
...
```{r tableCritiqueF1, echo=FALSE, message=FALSE, warning=FALSE}
nomcols <- names(tableF_p0.05)
show_table(tableF_p0.05[,1:11], 
...
```{r tableCritiqueF2, echo=FALSE, message=FALSE, warning=FALSE}
show_table(tableF_p0.05[,c(1,12:20)], 
           caption = "Distribution des valeurs critiques de F avec p = 0,05 (suite)",
...
```{r tableCritiqueF3, echo=FALSE, message=FALSE, warning=FALSE}
show_table(tableF_p0.05[,c(1,21:26)], 
           caption = "Distribution des valeurs critiques de F avec p = 0,05 (suite)",
...
La courte syntaxe R ci-dessous permet de générer le tableau \@ref(tab:tableCritiqueT) avec les valeurs critiques de *t* avec *p*&nbsp;=&nbsp;0,10, 0,05, 0,01 et 0,01.
