...
La courte syntaxe R ci-dessous permet de générer le tableau \@ref(tab:tableCritiqueChi2) avec les valeurs critiques du khi-deux pour différents degrés de signification (valeurs de *p*).
