...
if(knitr::is_latex_output() == FALSE){
    knitr::include_graphics('images/ImageCouverture.png', dpi = NA)
}
```
...
if(knitr::is_latex_output() == FALSE){  
  ...
  cat("\n\n**Pour citer cet ouvrage&nbsp;:** Apparicio Philippe et Jérémy Gelb (2022). *Méthodes quantitatives en sciences sociales&nbsp;: un grand bol d'R*. Institut national de la recherche scientifique. Licence CC&nbsp;BY-SA.") 
   cat("\n\n")
}
```
...
## Table des valeurs critiques de khi-deux {#annexe1}
## Table des valeurs critiques de Fisher {#annexe2}
## Table des valeurs critiques de *t* {#annexe3}
