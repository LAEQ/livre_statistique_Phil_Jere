...
* Pour classifier des observations :
  - **geocmeans** pour investiguer le résultat de classification floues
...
* Distance A-C : $\sqrt{(85-80)^2+(80-77)^2} = 5.83$
* Distance B-C : $\sqrt{(80-83)^2+(79-77)^2} = 3,60$
...
* Distance A-C : $|85-80|+|80-77| = 8$
* Distance B-C : $|80-83|+|79-77| = 5$
...
```{r quizClassif, echo=FALSE, results = "asis", warning=FALSE}
