...
Puisque les modèles multiniveaux sont une extension des modèles à effets mixtes (GLMM), nous allons retrouver globalement les mêmes conditions d'application (voir la section \@ref(sect093)), dont les principales sont&nbsp;:
...
### Modèle avec les variables indépendantes du niveau&nbsp;1 {#sect10412}
...
### Modèle avec les variables indépendantes aux niveaux 1 et 2 {#sect10413}
