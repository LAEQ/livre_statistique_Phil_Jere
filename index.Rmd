...
Si vous souhaitez télécharger l'intégralité des données en une fois, vous pouvez utiliser le lien suivant&nbsp;: https://downgit.github.io/#/home?url=https://github.com/LAEQ/livre_statistique_Phil_Jere/tree/master/data. Ceci est rendu possible par l'outil [DownGit](https://downgit.github.io/#/home).
...
```{r downloaffromgit, fig.align='center', echo=FALSE, auto_pdf = TRUE, fig.cap="Télécharger l'intégralité du livre",  out.width='50%'}
