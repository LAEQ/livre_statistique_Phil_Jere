...
```{r Licence, fig.align='center', echo=FALSE, auto_pdf = TRUE, fig.cap="La licence Creative Commons du livre",  out.width='100%'}
...
Il existe actuellement de nombreux livres sous licence ouverte écrits avec [rmarkdown](https://rmarkdown.rstudio.com/) avec le *package* `bookdown` [@xie2016bookdown], répertoriés sur le site de [https://bookdown.org/](https://bookdown.org/). Sans surprise, R étant un logiciel libre dédié aux méthodes statistiques et à la sciences des données, plusieurs abordent les méthodes quantitatives, notamment&nbsp;:
