gitbook.require(["gitbook", "lodash", "jQuery"], function(gitbook, _, $) {
  ...
  gitbook.events.bind("start", function(e, config) {
    ...
    var info = ['Raccourcis clavier (<> indiquent les flèches directionnelles):',
      '<gauche>/<droite>: passer à la page précédente/suivnate',
      's: Afficher  le volet latéral'];
    if (config.search !== false) info.push('f: Afficher la barre de recherche ' +
      '(Utiliser <haut>/<bas>/Entrer dans la barre de recherche pour naviguer entre les éléments trouvés; ' +
      'Appuyer sur Échap pour annuler la recherche)');
