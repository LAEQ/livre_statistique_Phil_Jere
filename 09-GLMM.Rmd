...
* Pour analyser des modèles GLM&nbsp;:
  ...
  - **merTools** permet d'explorer les résultats d'un GLMM.
  - **lmerTest** fourni des tests de significativité pour les coefficients d'un GLMM.
...
Notez que l'utilisation du terme effet aléatoire peut porter à confusion, car différentes utilisations en sont faites en fonction du champ d'études. Parmi les différentes définitions relevées par @gelman2005analysis d'un effet aléatoire, citons les suivantes&nbsp;: 
