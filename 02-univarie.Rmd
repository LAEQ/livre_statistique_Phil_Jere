...
```{r fig255, echo=FALSE, fig.align='center', fig.cap="18 distributions essentielles, design inspiré de [Sean Owen](https://medium.com/@srowen/common-probability-distributions-347e6b945ce4){target='_blank'}", auto_pdf=TRUE, out.width='95%'}
...
```{r figunivarie3, fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), auto_pdf = TRUE, fig.cap="Graphique en violon, boîte à moustaches et intervalle interquartile",  out.width='30%'}
...
Prenons un exemple concret dans ![](images/logos/Rlogo.png). Admettons que nous avons une variable comprenant 10 valeurs (oui, c'est un petit échantillon, mais c'est pour faire un exemple simple).
...
```{r figaccmtldist, fig.align='center', fig.cap="Ajustement des distributions de poisson et poisson avec excès de zéros", message=FALSE, warning=FALSE, auto_pdf=TRUE, include=identical(knitr:::pandoc_to(), 'html'), out.width='65%'}
library(gamlss.dist)
...
```{r FigParcCMM, fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), auto_pdf = TRUE, fig.cap="Accessibilité aux aires de jeux par secteur de recensement, Communauté métropolitaine de Montréal, 2016",  out.width='85%'}
