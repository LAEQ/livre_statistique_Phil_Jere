...
* la **moyenne arithmétique**, notée $\bar{x}$, est simplement la somme des données d'une variable divisée la nombre d'observation ($n$), soit $\bar{x} = \frac{\sum_{i=1}^n x_i}{n}$.
...
Une lecture attentive des valeurs des centiles permet de repérer la présence de valeurs extrêmes voire abérantes dans un jeu de données. Il n'est donc pas rare de les voir reportées dans un tableau de staistiques descriptives d'un article scientifique, et ce, afin de décrire succinctement les variables à l'étude.  


```{r tableCentiles, echo=FALSE, message=FALSE, warning=FALSE}

stats <- c("N", "Centiles","1","5","10", "25", "50", "75", "90", "95", "99")
C <- c(6212, ., 57.5, 59.1,60.3)


Statistiques | Copenhagen |  Montreal | Paris
------- | ------- | ------- | ------- 
N | | 6212 | |4723 | |3793
Percentiles |  |  | 
 1 | 57.5 | 59.2 | | 62.3
 5 | 59.1 | 61.1 | | 65.0
 10 | 60.3 | 62.3 | | 66.5
 25 (Q1) | 62.7 | 64.5 | 69.1
 50 (Q2) | 66.0 | 67.7 | 71.6
 75 (Q3) | 69.2 | 71.0 | 74.0
 90 | 71.9 | 73.7 | 76.0
 95 | 73.3 | 75.2 | 77.2
 99 | 76.5 | 78.9 | 81.0
