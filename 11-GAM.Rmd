...
```{r randomconstGAM, message=FALSE, warning=FALSE, dev = "png", dpi = 300}
library(itsadug)
...
```{r randomconstGAM2, message=FALSE, warning=FALSE, dev = "png", dpi = 300}
...
```{r randomconstGAM3, message=FALSE, warning=FALSE, dev = "png", dpi = 300}
dfpred <- data.frame(
  A65Pct = mean(dataset$A65Pct),
  A014Pct = mean(dataset$A014Pct),
  PopFRPct = mean(dataset$PopFRPct),
...
```{r randomconstcoefGAM, message=FALSE, warning=FALSE, dev = 'png', dpi = 300}
