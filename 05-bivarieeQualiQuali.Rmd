...
Pour vérifier l'existence d'associations significatives entre les modalités de deux variables qualitatives, il est possible de construire un **tableau de contingence** (section \@ref(sect051)), puis de réaliser le **test du khi-deux** (section \@ref(sect052)).
:::
