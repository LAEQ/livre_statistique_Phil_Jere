...
```{r fig013, fig.align='center', echo=FALSE, auto_pdf = TRUE, fig.cap="Un array avec trois dimensions",  out.width='15%'}
...
show_table(DureeImportation, 
           digits = 2, 
           col.names = c("Durée (secondes)","Fonction"),
...
##### Calcul d'une durée entre deux *datetime* {#sect014263}
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
```
```{r sectionsRstudio, fig.align='center', echo=FALSE, auto_pdf = TRUE, fig.cap='Navigation dans des sections de codes avec RStudio',  out.width='50%'}
...
```{r structFolder, fig.align='center', echo=FALSE, auto_pdf = TRUE, fig.cap="Structure de dossier recommandée pour un projet avec R",  out.width='50%', fig.pos = "H"}
knitr::include_graphics('images/introduction/structurationprojet.png', dpi = NA)
```
...
## Quiz de révision du chapitre {#sect0110}
