...
Si vous travaillez avec des collègues utilisant le logiciel SAS, il se peut que ces derniers vous partagent des fichiers dta. En utilisant à nouveau le package **foreign**, vous serez en mesure de les charger directement dans ![](images/logos/Rlogo.png).
...
df4 <- read.xlsx("data/priseenmain/SR_MTL_2016.xlsx",sheetIndex = 1,
                 as.data.frame = TRUE)
...
df5 <- read.xlsx2("data/priseenmain/SR_MTL_2016.xlsx",sheetIndex = 1, 
                  as.data.frame = TRUE,
...
durations <- data.frame(
  "duree" = c(d1,d2,d3,d4,d5),
  "fonction" = c("read.csv","read.dbf","read.dta","read.xlsx","read.xlsx2")
)
