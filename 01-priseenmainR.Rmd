...
```{r saveobj, fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), auto_pdf = TRUE, fig.cap="Image de la session avec RStudio",  out.width='50%'}
...
```{r loadobj, fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), auto_pdf = TRUE, fig.cap="Image de la session avec RStudio",  out.width='50%'}
knitr::include_graphics('images/introduction/load_session.png', dpi = NA)
```


## Conclusion et ressources pertinentes  {#sect018}
