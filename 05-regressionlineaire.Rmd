...
## Mise en œuvre dans R {#sect057}

### Les fonctions `lm`, `summary()` et `confint()` {#sect0571}
...
### Diagnostic sur un modèle {#sect0573}

#### Vérifier le nombre d'observations {#sect05731}
...
#### Vérifier la normalité des résidus {#sect05732}
...
#### Évaluer la linéarité et l'homoscédasticité des résidus {#sect05733}
...
```{r DiaHomoscedasticite, echo=TRUE, fig.align='center', fig.cap="Distribution des résidus en fonction des valeurs prédites", message=FALSE, warning=FALSE, out.width='75%'}
...
#### Vérifier la multicolinéarité excessive {#sect05734}
...
#### Réperer les valeurs très influentes du modèle {#sect05735}
...
#### Construite un nouveau modèle en supprimant les observations très influentes du modèle {#sect05736}
...
### Graphiques pour les effets marginaux {#sect0574}
...
#### Effet marginal pour une variable continue {#sect05741}
...
#### Effet marginal pour une variable avec une fonction polynomiale d'ordre 2 {#sect05742}
...
#### Effet marginal pour une variable transformée en logarithme {#sect05743}
...
#### Effet marginal pour une variable dichotomique {#sect05744}
...
#### Effet marginal pour une variable polytomique {#sect05745}
...
#### Effet marginal pour une variable d'interaction (deux VI continues) {#sect05746}
...
#### Effet marginal pour une variable d'interaction (une VI continue et une VI dichotomique) {#sect05747}
