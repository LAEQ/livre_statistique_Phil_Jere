...
JÉRÉMY PEUX-TU FAIRE UN GRAPHIQUE DE L'EFFET MARGINAL SVP : X = Pct_FR, Y = VegPct, Couleur = VILLEMTL (rouge : 1, bleu : 0) avec des couleurs pour les deux VILLEMTL vers AUTRE x=PCT_!!! Mais aussi les pentes pour 0 et 1 svp (voir https://www.econometrics-with-r.org/8-3-interactions-between-independent-variables.html).
