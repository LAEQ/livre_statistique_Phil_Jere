...
```{r residusmultinom, fig.align="center", fig.cap="Diagnostic général des résidus simulés pour le modèle multinomial", message=FALSE, warning=FALSE, out.width=}
...
ggplot(data = dataset) + 
  ...
  labs(x = 'Temps de déplacement (minutes)',
       y = '',
       subtitle = "modèles de Gamma et gaussien")
```
