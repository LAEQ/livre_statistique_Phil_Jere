...
Tout semble aller pour le mieux après ce second passage (figure : \@ref(fig:cookdistbeta3)). Si nous avions continué à observer des valeurs aussi influentes, nous aurions dû commencer à sérieusement questionner nos données. La prochaine étape du diagnostic est donc l'analyse des résidus simulés.
...
Le modèle parvient à expliquer 90% de la déviance totale et obtient des R^2^ très élevé. Il obtient cependant un RMSE de 0,10 soit une erreur quadratique moyenne de 10% dans la prédiction ce qui est tour de même important. Le modèle ne semble pas souffrir particulièrement de sur-ajustement comme les pseudo R^2^ auraient pu nous le laisser penser. 
