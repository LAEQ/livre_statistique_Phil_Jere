...
* Pour les corrélations : 
  - **correlation**, de l'ensemble de packages **easy_stats**, offrant une large gamme de méthodes de corrélation.
  - **boot** pour réaliser des corrélations avec *bootstrap*.
  - **Hmisc** pour calculer des corrélations de Pearson et Spearman.
  - **ppcor** pour des corrélations partielles.
...
Par exemple, au niveau des secteurs de recensement d’une ville canadienne, on pourrait vouloir vérifier si le revenu médian des ménages et le coût moyen du loyer varient dans le même sens que la couverture végétale ; et s'ils varient en sens inverse des niveaux moyens de dioxyde d’azote ou de bruit routier.
