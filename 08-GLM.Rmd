...
```{r diagressimcumul2, echo=FALSE, fig.align="center", fig.cap="Diagnostic variable par variable des résidus simulés du modèle des cotes proportionnelles", fig.pos= "H", message=FALSE, warning=FALSE, out.width="100%"}
...
```
```{r diagressimcumul3, echo=FALSE, fig.align="center", fig.cap="Diagnostic variable par variable des résidus simulés du modèle des cotes proportionnelles (arpès correction)", fig.pos="H", message=FALSE, warning=FALSE, out.width="100%"}
...
```{r residusmultinom2, echo=FALSE, fig.align="center", fig.cap="Diagnostic par variable des résidus simulés pour le modèle multinomial", fig.pos="H", message=FALSE, warning=FALSE, out.width="100%"}
...
L’interprétation des paramètres est identique à celle d’un modèle de Poisson. Le paramètre *p* représente la proportion de faux zéros dans la variable *Y* une fois que sont contrôlées les variables indépendantes.
...
```{r diagzip, fig.cap="Diagnostic général des résidus simulés du modèle de Poisson avec excès de zéros ajusté", fig.align='center', out.width = '100%',message=FALSE, warning=FALSE}
...
```{r gammaresids2, message=FALSE, warning=FALSE, out.width='100%', fig.cap = "Diagnostic général des résidus simulés du modèle Gamma", fig.align = "center", echo = TRUE}
plot(sim_res)
```
