...
## 	Conclusion sur les modèles linéaires généralisés {#sect085}
...
```{r GLMfinal, echo=FALSE, fig.align="center", fig.cap="Résumé graphique des principaux GLM abordés", message=FALSE, warning=FALSE, out.width=}
knitr::include_graphics("images/glm/guide_GLM.png", dpi = 300)
```

## Quiz final sur les modèles GLM {#sect086}
