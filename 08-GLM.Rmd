...
### Vérification l’ajustement {#sect0815}
...
```{r figresidsimbinomHistoUnif, message=FALSE, warning=FALSE, out.width='60%', fig.cap="Distribution des résidus simulés pour le modèle binomial", fig.align="center", fig.pos = "H"}
library(DHARMa)
...
```{r figresidsimbinom, echo=FALSE, fig.align="center", fig.cap="Diagnostic des résidus simulés par le package DHARMa", fig.pos="H", message=FALSE, warning=FALSE, out.width='80%'}
...
```{r equlibresensispeci, message=FALSE, warning=FALSE, out.width='80%', fig.cap="Point d'équilibre entre sensibilité et spécificité", fig.align="center", dev = "png", dpi = 300}
library(ROCR)
...
```{r figpaysbinom, message=FALSE, warning=FALSE, fig.align="center", fig.cap= "Rapports de cote pour les différents pays de l'UE", out.width = "80%", dev = "png", dpi = 300}
...
```{r figagebinom, message=FALSE, warning=FALSE, fig.align="center", fig.cap= "Effet de l'âge sur la probabilité d'utiliser le vélo comme moyen de déplacement pour son trajet le plus fréquent", out.width="65%"}
...
```
```{r diagressimcumul3, echo=FALSE, fig.align="center", fig.cap="Diagnostic des variables indépendantes et des résidus simulés du modèle des cotes proportionnelles (après correction)", fig.pos="H", message=FALSE, warning=FALSE, out.width="100%"}
...
```{r predpricecatveg, message=FALSE, warning=FALSE, out.width = "65%", fig.align = "center", fig.cap = "Prédiction de la probabilité d'appartenance aux trois catégories de prix en fonction de la densité de végétation", fig.pos = "H"}
...
```{r residusmultinom, fig.align="center", fig.cap="Diagnostic général des résidus simulés pour le modèle multinomial", message=FALSE, warning=FALSE, out.width="65%", fig.pos="H"}
...
```{r residusmultinom3, message=FALSE, warning=FALSE, fig.cap = "Diagnostic général des résidus simulés pour le modèle multinomial (version 3)", fig.align = "center", out.width = "65%", echo = FALSE}
# Extraire les prédictions du modèle
categories <- c("B","C","D")
...
```{r residusmultinom4, message=FALSE, warning=FALSE, fig.cap = "Diagnostic général des résidus simulés pour le modèle multinomial (version 4)", fig.align = "center", out.width = "65%", echo = FALSE}
# Extraire les prédictions du modèle
categories <- c("B","C","D")
...
```{r poisscookdist2, fig.align="center", fig.cap="Distances de Cook pour le modèle de Poisson après avoir retiré les valeurs aberrantes", message=FALSE, warning=FALSE, out.width='60%', dev = "png", dpi = 300}
...
```{r simrespoiss, message=FALSE, warning=FALSE, fig.align ="center", fig.cap="Analyse globale des résidus simulés pour le modèle de quasi-Poisson", out.width = "65%", dev = "png", dpi = 300}
# Génération de 1000 simulations pour chaque prédiction
disp <- 1.918757 # trouvable dans le summary(modele2)
nsim <- 1000
cols <- lapply(1:length(preds),function(i){
...
```{r cookdistnb, fig.cap = "Distances de Cook pour le modèle binomial négatif", fig.align = "center", message=FALSE, warning=FALSE, out.width='65%', dev = "png", dpi = 300}
library(mgcv)
# Chargement des données
data_accidents <- read.csv("data/glm/accident_pietons.csv", sep = ";")
# Ajustement d'une première version du modèle
...
```{r cookdistnb2, fig.cap = "Distances de Cook pour le modèle binomial négatif (après avoir retiré quatre observations fortement influentes)", fig.align = "center", message=FALSE, warning=FALSE, out.width='65%', dev = "png", dpi = 300}
...
```{r diagresnb, fig.cap = "Diagnostic général des résidus simulés pour le modèle binomial négatif", fig.align = "center", message=FALSE, warning=FALSE, out.width='65%', dev = "png", dpi = 300}
...
```{r surdispnb, message=FALSE, warning=FALSE, fig.aling = "center", fig.cap="Représentation de la sur-dispersion des données dans le modèle de Poisson", fig.pos="H", dev = "png", out.width = "65%", dpi = 300}
# Extraction des prédictions du modèle
mus <- predict(modelnb, type = "response")
# Création d'un DataFrame pour contenir la prédiction et les vraies valeurs
df1 <- data.frame(
...
```{r diagzip, echo=FALSE, fig.align='center', fig.cap="Diagnostic général des résidus simulés du modèle de Poisson avec excès de zéros ajusté", message=FALSE, warning=FALSE, out.width='65%'}
invisible(capture.output({
...
```{r diagzip2, fig.cap="Diagnostic général des résidus simulés du modèle de Poisson avec excès de zéros ajusté (sans valeurs aberrantes)", fig.align='center', out.width = '65%',message=FALSE, warning=FALSE, fig.pos = "H", dev = "png", dpi = 300}
...
```{r message=FALSE, warning=FALSE, gausscook2, echo=FALSE, fig.align="center", fig.cap="Distances de Cook pour le modèle gaussien après suppression des observations influentes", out.width="65%", dev = "png", dpi = 300}
...
```{r gaussresid, message=FALSE, warning=FALSE, fig.align = "center", fig.cap = "Diagnostic général des résidus simulés pour le modèle gaussien", out.width = "65%", fig.pos = "H", dev = "png", dpi = 300}
# Extraction des prédictions du modèle
...
```{r gausssim, message=FALSE, warning=FALSE, fig.align = "center", fig.cap = "Comparaison de la distribution originale de la variable et des simulations issues du modèle", out.width = "65%", fig.pos = "H", dev = "png", dpi = 300}
...
```{r studentresid, message=FALSE, warning=FALSE, fig.align = "center", fig.cap = "Diagnostic général des résidus simulés pour le GLM avec distribution de Student", out.width = "65%", fig.pos = "H"}
# Extraction des prédictions du modèle
mus <- predict(modele, type = 'response')
...
```{r studentresid2, message=FALSE, warning=FALSE, fig.align = "center", fig.cap = "Distribution des résidus simulés du modèle GLM avec distribution de Student", out.width = "60%", dev = "png", dpi = 300}
ggplot()+
...
```{r studentresid3, message=FALSE, warning=FALSE, fig.align = "center", fig.cap = "Simulations issues des modèles gaussien et de Student, comparées aux données originales", echo = F, out.width = "60%", fig.pos = "H", dev = "png", dpi = 300}
...
```{r gammadatadistrib, fig.cap = "Distribution des temps de trajet diurne à Montréal", fig.align = "center",  message=FALSE, warning=FALSE, out.width='50%', dev = "png", dpi = 300}
# Chargement des données
...
```{r gammaresids2, message=FALSE, warning=FALSE, out.width='100%', fig.cap = "Diagnostic général des résidus simulés du modèle Gamma", fig.align = "center", echo = TRUE, fig.pos = "H", out.width='65%', dev = "png", dpi = 300}
plot(sim_res)
```
...
```{r gammaresids3, message=FALSE, warning=FALSE, out.width='65%', fig.cap = "Diagnostic général des résidus simulés du modèle Gamma (après suppression d'environ 620 valeurs aberrantes)", fig.align = "center", echo = TRUE, dev = "png", dpi = 300}
...
show_table(tableau, 
    caption = "Carte d'identité du modèle bêta",
    col.names = NULL, 
    col.to.resize = c(2),
    col.width = "8cm",
    position = "HOLD_position"
...
show_table(df, 
    caption = "Variables indépendantes utilisées dans le modèle bêta",
    col.names = c("Nom de la variable","Signification","Type de variable","Mesure"),
    align= c("l", "l", "l", "l"),
    col.to.resize = c(2,4),
    col.width = "5cm",
...
```{r cookdistbeta, fig.align="center", fig.cap="Distances de Cook pour le modèle GLM bêta", message=FALSE, warning=FALSE, out.width="65%", dev = "png", dpi = 300}
# Ajustement d'une première version du modèle
modele <- gam(hot ~
                A65Pct + A014Pct + PopFRPct + PopMVPct +
                poly(prt_veg, degree=2) + Arrond,
...
```{r cookdistbeta2, fig.align="center", fig.cap="Distances de Cook pour le modèle GLM bêta (suppression de deux observations influentes)", message=FALSE, warning=FALSE, out.width="65%", dev = "png", dpi = 300}
...
```{r cookdistbeta3, fig.align="center", fig.cap="Distances de Cook pour le modèle GLM bêta (suppression de trois observations influentes)", message=FALSE, warning=FALSE, out.width="65%", dev = "png", dpi = 300}
...
```{r residsimbeta, message=FALSE, warning=FALSE, fig.cap = "Diagnostic général des résidus simulés du modèle bêta", fig.align = "center", out.width = "65%", fig.pos = "H", dev = "png", dpi = 300}
# Extraction de phi
...
```{r residsimbeta2, echo=FALSE, fig.align="center", fig.cap="Relation entre chaque variable indépendante et les résidus simulés du modèle bêta", fig.pos="H", message=FALSE, warning=FALSE, out.width="100%"}
...
```{r residsimbeta3, message=FALSE, warning=FALSE, fig.cap = "Relation entre la variable Arrondissement et les résidus simulés du modèle bêta", fig.align = "center", out.width = "65%", fig.pos = "H", dev = "png", dpi = 300}
df <- data.frame(
...
```{r residsimbeta4, message=FALSE, warning=FALSE, fig.cap = "Comparaison entre la distribution originale et les simulations issues du modèle", fig.align = "center", out.width = "60%", fig.pos = "H", dev = "png", dpi = 300}
...
```{r betaArrond, message=FALSE, warning=FALSE, fig.cap = "Rapports de cote pour les arrondissements dans le modèle bêta", fig.align = "center", out.width = "85%"}
...
show_table(tableau_ok, 
    caption = "Résultats pour le modèle GLM bêta",
    col.names = c('Variable',"Coeff.","RC","Val.p","IC 2,5 % RC","IC 97,5 % RC", "Sign."),
    align= c("l", "r", "r", "r", "r", "r", "r")
)
```

```{r betaFR, message=FALSE, warning=FALSE, fig.cap = "Effets marginaux des variables pourcentage de personnes à faible revenu et densité de végétation", fig.align = "center", out.width = "60%", dev = "png", dpi = 300}
...
```{r GLMfinal, echo=FALSE, fig.align="center", fig.cap="Résumé graphique des principaux GLM abordés", out.width="80%", message=FALSE, warning=FALSE, out.width="100%"}
