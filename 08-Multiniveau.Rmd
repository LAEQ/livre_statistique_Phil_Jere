# Régressions multiniveaux  {#chap08}
...
show_table(TableauModele1[,c(1,2,3,5)],
           digits = 3,
...
show_table(TableauModele2[,c(1,2,3,5)],
           digits = 3,
...
Autrement dit, comparativement à un modèle sans centrage, les valeurs des coefficients pour les variables indépendantes seront les mêmes dans le premier cas (seule la valeur de la constante va changer) tandis qu'elles seront différents dans le second cas.
...
show_table(TableauModele3[,c(1,2,3,5)],
           digits = 3,
...
show_table(TableauModele4[,c(1,2,3,5)],
           digits = 3,
...
## Conditions d'application des régressions multiniveaux {#sect083}
...
### Le modèle avec les variables indépendantes aux niveaux 1 et 2 {#sect08413}
...
### Le modèle complet avec une interaction {#sect08414}
