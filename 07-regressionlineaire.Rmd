...
```{r GraphCookLev, echo=FALSE, fig.align='center', fig.cap="Repérer graphiquement les valeurs influentes du modèle", message=FALSE, warning=FALSE, out.width='75%', dev="png", dpi=300}
library(car)
library(ggpubr)
DistanceCook <- cooks.distance(modele3)
...
```{r DiaGraphCookLev, echo=TRUE, fig.align='center', fig.cap="Repérer graphiquement les valeurs influentes du modèle", message=FALSE, warning=FALSE, out.width='75%', dev="png", dpi=300}
library(car)
library(ggpubr)
DistanceCook <- cooks.distance(modele3)
LeverageValue <- hatvalues(modele3)
