...
Les différentes résultats pour les coefficients sont reportées au tableau \@ref(tab:dataregmodel2). 
...
Pour éviter d'oublier quelle est la modalité de référence (valeur de 0), nous verrons plus tard (dans la section mise en œuvre des modèles de régression dans ![](Images/Rlogo.png) (section \@ref(sect077)) qu'il peut être préférable de définir un facteur avec la fonction `as.factor` et d'indiquer la catégorie de référence avec la fonction `relevel(x, ref)`.
:::
