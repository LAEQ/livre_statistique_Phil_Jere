...
```{r fig3A, echo=FALSE, fig.align='center', fig.cap="Noyer dans le plastique selon  [Reuters Graphics](https://graphics.reuters.com/ENVIRONMENT-PLASTIC/0100B275155/index.html){target='_blank'}", auto_pdf=TRUE, out.width='90%'}
...
```{r fig315, fig.align='center', include=identical(knitr:::pandoc_to(), 'html'), auto_pdf = TRUE, fig.cap="Graphique à facettes",  out.width='65%'}
...
* En utilisant le nom de la couleur dans une chaîne de caractère : `"chartreuse4"`. ![](images/logos/Rlogo.png) dispose 657 noms de couleurs prédéfinis. Pour tous les afficher, utilisez la fonction `colors()` qui permet de les visualiser (figure \@ref(fig:figcolors)) .
...
```{r fig319, fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), auto_pdf = TRUE, fig.cap="Empiler les données d'un dataframe",  out.width='30%'}
knitr::include_graphics('images/magie_graphiques/melting.png', dpi = NA)
```

```{r fig320, fig.align='center', include=identical(knitr:::pandoc_to(), 'html'), auto_pdf = TRUE, fig.cap="Histogrammes en facettes",  out.width='65%'}
library(reshape2)
...
```{r fig323, fig.align='center', include=identical(knitr:::pandoc_to(), 'html'), auto_pdf = TRUE, fig.cap="Histogramme coloré",  out.width='65%'}
...
```{r fig327, fig.align='center', fig.cap="Nuage de points simple sans données aberrantes", warning=FALSE, auto_pdf=TRUE, include=identical(knitr:::pandoc_to(), 'html'), out.width='65%'}
ggplot(data = data_co2)+
  geom_point(aes(x = Urbanisation, y = CO2t_hab))+
  labs(x = "Niveau d'urbanisation (%)",
       y = 'tonnes de CO2 annuelle / habitant',
...
```{r fig342, fig.align='center', fig.cap="Graphique en violon et boite à moustaches", warning=FALSE, auto_pdf=TRUE, include=identical(knitr:::pandoc_to(), 'html'), out.width='65%'}
ggplot(data = data_co2_comp)+
  geom_violin(aes(y = region7,x = CO2t_hab))+
...
```{r fig344, fig.align='center', include=identical(knitr:::pandoc_to(), 'html'), auto_pdf = TRUE, fig.cap="Graphiques en barres simples",  out.width='75%'}
...
```{r fig346, fig.align='center', fig.cap="Graphique en pointes de tarte", message=FALSE, warning=FALSE, auto_pdf=TRUE, include=identical(knitr:::pandoc_to(), 'html'), out.width='65%'}
library(dplyr)
...
* [The R Graph Gallery](https://www.r-graph-gallery.com/), probablement **LE** site web proposant le plus de matériel sur comment réaliser des grahiques dans ![](images/logos/Rlogo.png).
